 ...
 *
 * Based on com.mobeta.android.dslv
 *
 * @author heycosmo, xBlackCat
 */
public class DragSortListView extends ListView {
     ...
     */
    private float mFloatAlpha = 1f;
    private float mCurrFloatAlpha = 1f;
    ...
    public DragSortListView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mSlideRegionFrac = Math.max(
                    0.0f,
                    Math.min(
                            1.0f, 1.0f - a.getFloat(
            ...
            if (useDefault) {
                ...
                int removeMode = a.getInt(
                        R.styleable.DragSortListView_remove_mode_2,
     ...
     *
     * @return The ListAdapter set as the argument of {@link #setAdapter(ListAdapter adapter)}
     */
     ...
     * your own is not passed, the default {@link org.xblackcat.android.ui.dslv.SimpleFloatViewManager}
    ...
    public interface FloatViewManager {
         ...
         *                 to favorite_add {@link android.widget.ListView#getHeaderViewsCount()} to the index).
         ...
         *                  and the offset provided in {@link org.xblackcat.android.ui.dslv.DragSortListView#startDrag}.
     ...
     * items are lifted (see {@link org.xblackcat.android.ui.dslv.DragSortController#setDragInitMode(int)}).
     ...
     * {@link org.xblackcat.android.ui.dslv.DragSortListView.DragScrollProfile}.
     *
     * @param ssp
     */
    ...
    private static int buildRunList(
            SparseBooleanArray cip, int rangeStart,
     ...
     * {@link org.xblackcat.android.ui.dslv.DragSortListView#setDragScrollProfile(DragScrollProfile)} to
     * set custom profile.
     *
     * @author heycosmo
     */
