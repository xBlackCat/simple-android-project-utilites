 ...
 * {@link DragSortListView#setOnTouchListener(android.view.View.OnTouchListener)}  and
 * {@link DragSortListView#setFloatViewManager(org.xblackcat.android.ui.dslv.DragSortListView.FloatViewManager)} of your
...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        ...
        if (mCanDrag && !mDragging &&
                (mHitPos != MISS || mFlingHitPos != MISS)) {
            if (mHitPos != MISS) {
